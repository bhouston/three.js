...
class NodeBuilder {
	...
	generateConst( type, value = null ) {
		...
		if ( value === null ) {
			...
			else if ( type === 'vec2' || type === 'uvec2' || type === 'ivec2' || type === 'hvec2' || type === 'bvec2' ) value = new Vector2();
			else if ( type === 'vec3' || type === 'uvec3' || type === 'ivec3' || type === 'hvec3' || type === 'bvec3' ) value = new Vector3();
			else if ( type === 'vec4' || type === 'uvec4' || type === 'ivec4' || type === 'hvec4' || type === 'bvec4' ) value = new Vector4();
