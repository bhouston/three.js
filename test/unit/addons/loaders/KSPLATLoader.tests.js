	...
	QUnit.module( 'Loaders', () => {
		...
		QUnit.module( 'KSPLATLoader', () => {
			...
			QUnit.test( 'parses uncompressed KSPLAT spherical harmonics data', ( assert ) => {
				...
				assert.deepEqual( Array.from( data.getAttribute( 'sphericalHarmonics1' ).array ), [ 129, 132, 135, 130, 133, 136, 131, 134, 137 ], 'SH1 coefficients are remapped to RGB triplets' );
