	...
	QUnit.module( 'Loaders', () => {
		...
		QUnit.module( 'SPZLoader', () => {
			...
			QUnit.test( 'parses SPZ spherical harmonics degree 1 data', ( assert ) => {
				...
				assert.deepEqual( Array.from( data.getAttribute( 'sphericalHarmonics1' ).array ), [
					129, 130, 131,
					132, 133, 134,
					135, 136, 137
				], 'SH1 coefficients' );
			...
			QUnit.test( 'parses SPZ spherical harmonics degree 2 data', ( assert ) => {
				...
				assert.deepEqual( Array.from( data.getAttribute( 'sphericalHarmonics2' ).array ), [
					138, 139, 140,
					141, 142, 143,
					144, 145, 146,
					147, 148, 149,
			...
			QUnit.test( 'parses SPZ spherical harmonics degree 3 data', ( assert ) => {
				...
				assert.deepEqual( Array.from( data.getAttribute( 'sphericalHarmonics3' ).array ), [
					153, 154, 155,
					156, 157, 158,
					159, 160, 161,
					162, 163, 164,
