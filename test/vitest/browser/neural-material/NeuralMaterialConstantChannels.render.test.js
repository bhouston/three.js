...
import { CHANNELS } from '../../../../examples/jsm/neural-material/NeuralMaterialFormat.js';
import { classifyMaterialChannels } from '../../../../examples/jsm/neural-material/NeuralMaterialSource.js';
import { reconstructFinalNormal } from '../../../../examples/jsm/neural-material/NeuralMaterialNodeMaterial.js';
import { createTestRenderer } from '../helpers/webgpuEval.js';

// Regression coverage for a real bug: `NeuralMaterialFormat.js`'s anisotropy
...
//
// Unlike NeuralMaterialNodeMaterial.test.js (which evaluates
...
// `MeshPhysicalNodeMaterial`, built the same way `NeuralMaterialNodeMaterial`
...
describe( 'Addons > Neural > NeuralMaterial > constant-channel rendering (real WebGPU, lit)', () => {
	...
	// Builds a material the same way `NeuralMaterialNodeMaterial`'s
	...
	function buildTestMaterial() {
		...
		// NeuralMaterialNodeMaterial.test.js uses, but applied per-fragment
