...
import { previewColor } from '../../../../examples/jsm/neural-material/NeuralMaterialFormat.js';
...
// preview (NeuralMaterialNodeMaterial.setDebugView and NeuralMaterialSource.
...
describe( 'Addons > Neural > NeuralMaterial > NeuralMaterialFormat.previewColor (real WebGPU)', () => {
	...
	it( 'size 3 override on a reconstructed vec3 normal preserves z (the actual fix)', async () => {
		...
		// view-space normal, same shape NeuralMaterialNodeMaterial.setDebugView
		// and NeuralMaterialSource.buildChannelPreviewMaterials actually pass.
