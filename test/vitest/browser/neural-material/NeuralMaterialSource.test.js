...
import { buildPackedColorNodes } from '../../../../examples/jsm/neural-material/NeuralMaterialSource.js';
import { getChannel, layoutChannels } from '../../../../examples/jsm/neural-material/NeuralMaterialFormat.js';
...
// NeuralMaterialSource.js's flattenChannelComponents) - a wrong sign here
...
describe( 'Addons > Neural > NeuralMaterial > NeuralMaterialSource.buildPackedColorNodes (real WebGPU)', () => {
	...
	it( 'a channel packed alone as the 5th total component (its own render target) keeps the same sign convention as when packed in the first four', async () => {
		...
		// always-zero padding slots (see NeuralMaterialFormat.js/
