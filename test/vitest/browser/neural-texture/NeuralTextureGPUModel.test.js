...
import {
	...
	NeuralTextureGPUModel
} from '../../../../examples/jsm/neural-texture/NeuralTextureGPUModel.js';
import { withTestRenderer } from '../helpers/webgpuEval.js';

// NeuralTextureGPUModel.js only *computes* a storage-buffer layout (offsets,
...
describe( 'Addons > NeuralTexture > NeuralTextureGPUModel (storage buffer layout)', () => {
	...
	describe( 'NeuralTextureGPUModel buffer allocation', () => {
