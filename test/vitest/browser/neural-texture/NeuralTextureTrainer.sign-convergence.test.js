...
import { NeuralTextureTrainer } from '../../../../examples/jsm/neural-texture/NeuralTextureTrainer.js';
import { evaluateNeuralTextureRaw, buildLevelTextures } from '../../../../examples/jsm/neural-texture/NeuralTextureNodeMaterial.js';
import { bakeColorNodeToTexture } from '../../../../examples/jsm/neural-texture/NeuralTextureSource.js';
import { applyChannelActivation } from '../../../../examples/jsm/neural/NeuralOutputActivations.js';
...
// NeuralMaterialFormat.test.js) and reconstructFinalNormal itself shown to
// treat +/- (dx, dy) symmetrically (see NeuralMaterialNodeMaterial.test.js),
...
// NeuralMaterialSource.test.js's "packed alone" case): 3 filler sigmoid
...
describe( 'Addons > Neural > NeuralTexture > NeuralTextureTrainer sign convergence (real WebGPU, end-to-end training)', () => {
