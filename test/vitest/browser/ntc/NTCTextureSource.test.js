...
// ground truth NTCTrainer samples from. Two ways this could quietly
...
describe( 'Addons > Neural > NeuralTexture > NTCTextureSource.bakeColorNodeToTexture (real WebGPU)', () => {
	...
	it( 'round-trips raw UV consistently: baking at (u, v) and reading back at pixel (u, v) agree, despite the internal V-flip', async () => {
		...
		// kernel depend on (see the long comment in NTCTextureSource.js): the
