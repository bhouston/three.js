...
import { computeGridLevels, createLatentGrid, createNeuralTextureModel } from '../../../../examples/jsm/neural-texture/NeuralTextureModel.js';

describe( 'Addons > Neural > Neural-Texture > NeuralTextureModel', () => {

	describe( 'createNeuralTextureModel', () => {
